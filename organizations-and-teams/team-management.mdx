...
Effective team management is crucial for collaboration in Artemis Search. This guide will show you how to manage your team members, including inviting new members and managing roles.
...
<Steps>
  ...
  <Step title="Initiate Invite">
    Find the 'Invite Member' card and click on it.
  </Step>
...
<Note>
  Invited members will receive an email with instructions on how to join your organization. They will need to create an Artemis Search account if they don't already have one.
</Note>
...
1. Regularly review your team list to ensure it's up-to-date
2. Remove access for members who are no longer part of your organization
3. Use descriptive names or email addresses when inviting new members to avoid confusion

## Next Steps

Now that you know how to manage your team, learn about [managing projects](/projects/managing-projects) to organize your work effectively.