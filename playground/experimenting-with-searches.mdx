...
<AccordionGroup>
  <Accordion title="Simple Keyword Search" icon="search">
    Start with basic keyword searches to familiarize yourself with the system.
    
    Example: "artificial intelligence"
  </Accordion>
  
  <Accordion title="Phrase Search" icon="quote-right">
    Use quotes to search for exact phrases.
    
    Example: "machine learning applications in healthcare"
  </Accordion>
  
  <Accordion title="Conceptual Search" icon="brain">
  ...
  <Accordion title="Attribute-based Search" icon="tags">
...
```plaintext Search: Companies that require HIPAA compliance
...
```plaintext Search: Sustainable fashion brands using recycled materials
...
```plaintext Search: AI startups focused on natural language processing
