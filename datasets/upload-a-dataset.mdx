...
3. A prepared dataset in the correct format (pickled pandas dataframe)
...
<Card title="Dataset Format" icon="table">
  - File type: Pickled pandas dataframe
  - Required columns:
...
<Steps>
  <Step title="Navigate to Your Project">
    Go to the Artemis Search dashboard and select the project you want to add the dataset to.
  </Step>
  ...
  <Step title="Provide Dataset Details">
    ...
    2. Click the upload area to select your pickled pandas dataframe file
  </Step>
