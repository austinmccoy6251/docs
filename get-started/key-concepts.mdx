...
<Accordion title="What parameters can you adjust?">
  - **Synthetic Dataset Size**: Controls how much synthetic data is generated for each search request. This parameter must be between 1 and 70. Tuning this parameter allows you to balance between search accuracy and performance.
