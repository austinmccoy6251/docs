...
```bash
curl -X GET "https://api.search-artemis.com/api/fly-search?search_query=HIPAA%20compliant%20companies&num_batches=2&clear_flag=true&top_k=5" \
...
url = "https://api.search-artemis.com/api/fly-search"
params = {
