...
Artemis Search offers several parameters to fine-tune your search queries and results. This guide explains each parameter and how to use them effectively.
...
```bash
curl -X GET "https://api.search-artemis.com/search?search_query=HIPAA%20compliant%20companies&num_batches=2&clear_flag=true&top_k=5" \
