...
```bash
curl -X GET "https://app.search-artemis.com/api/fly-search?search_query=HIPAA%20compliant%20companies&num_batches=2&clear_flag=true&top_k=5" \
...
url = "https://app.search-artemis.com/api/fly-search"
params = {
