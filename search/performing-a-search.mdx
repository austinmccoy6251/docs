...
Artemis Search provides a powerful and intuitive interface for performing intelligent searches on your datasets. This guide will walk you through the process of executing a search query.

## Prerequisites

Before you begin, ensure that:
- You have [created a project](/projects/create-a-project) in Artemis Search
- You have [uploaded and activated a dataset](/datasets/upload-and-activate) for your project
...
<Note>
  Artemis Search excels at queries requiring reasoning. For example, instead of just finding companies related to medicine or HIPAA compliance, it will return companies that actually match the criteria of requiring HIPAA compliance.
</Note>
