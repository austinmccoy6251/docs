...
Projects are the highest level of organization in Artemis Search. Each project is dedicated to a particular search task, allowing you to efficiently manage and configure your intelligent searches.
...
The status of your project is determined by two main factors:
