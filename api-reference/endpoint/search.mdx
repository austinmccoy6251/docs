...
This field may be null if the search encountered a critical error.
  ...
  <ResponseField name="error" type="string">
    ...
    <ResponseField name="error_type" type="no_bearer_token | invalid_bearer_token | api_key_not_set | invalid_api_key | metadata_not_found | filter_columns_not_found | filter_query_error | dataset_embedding_not_found | dataset_tag_not_found | dataset_empty">
